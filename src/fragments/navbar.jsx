        ...
        <div className="offcanvas-body">
            <ul className="navbar-nav justify-content-start flex-grow-1 pe-3">
                ...
                <li className="nav-item">
                    <Link className="nav-link" aria-current="page" to="/infoView">Inicio</Link>
                </li>

                <li className="nav-item">
                    <Link className="nav-link" aria-current="page" to="/form">Cadastrar</Link>
                </li>

                <li className="nav-item">
                    <Link className="nav-link" aria-current="page" to="/ocorrencias">Ocorrencias</Link>
                </li>
